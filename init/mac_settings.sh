...
# Kyle's macOS Settings
# inspired by https://mths.be/macos

echo 'Setting mac configuration...'
...
# defaults write NSGlobalDomain AppleHighlightColor -int 3
...
# Trackpad: enable right click on two fingers
defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadRightClick -bool true
defaults -currentHost write NSGlobalDomain com.apple.trackpad.enableSecondaryClick -bool true

# Increase sound quality for Bluetooth headphones/headsets
# TODO: does this still go something?..
...
# defaults write com.apple.frameworks.diskimages kip-verify-locked -bool true
...
# open "${HOME}/.themes/Dracula.itermcolors"
...
echo "macOS Settings Applied, restart your computer for them to take effect!"
done
